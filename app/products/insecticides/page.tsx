...
const features = [
    {
        ...
        description:
            "Choose crop protection solutions based on the pest, crop, and approved application requirements.",
    ...
    {
        number: "02",
        title: "Support Healthy Crops",
        description:
            "Manage insect damage as part of an integrated approach to maintaining crop health throughout the season.",
    ...
    },
    {
        ...
        description:
            "Follow product labels, recommended safety precautions, and local guidance for responsible insecticide use.",
            ...
            >
                ...
                <div className="mx-auto w-full max-w-7xl px-6 pb-28 pt-20 md:px-10">
                    <nav
                        ...
                        className="mb-8 flex items-center gap-3 text-sm text-green-100"
                    >
                        <Link
                            href="/"
                    ...
                    >
                        Insect<span className="text-yellow-300">icides</span>
                    </h1>

                    <p className="mt-6 max-w-xl text-lg leading-relaxed text-green-50 md:text-2xl">
                        Protecting your crops.
                        <br />
                        Nurturing a healthier tomorrow.
                    </p>

                    <a
                        href="#insecticide-solutions"
                ...
                <div className="rounded-t-2xl bg-white px-6 py-10 shadow-[0_12px_45px_rgba(20,65,40,0.08)] md:px-12 md:py-14 lg:px-16">
                    <section aria-labelledby="about-heading">
                        ...
                        <p className="my-8 border-l-4 border-green-500 pl-5 text-lg italic leading-relaxed text-slate-600 md:text-xl">
                            Effective crop protection begins with understanding your
                            crop and identifying the pests that affect it.
                        </p>
                        ...
                        <p className="text-base leading-8 text-slate-600 md:text-lg">
                            ...
                            harmful insects as part of a considered crop management
                            approach.
                        </p>

                        <p className="mt-5 text-base leading-8 text-slate-600 md:text-lg">
                            Selecting the right product depends on the crop, target pest,
                            and registered use. Always refer to the product label for
                            application rates, protective equipment, and pre-harvest
                            intervals.
                        </p>
                    </section>
                    ...
                    >
                        <header className="mb-10 text-center">
                            ...
                            >
                                Thoughtful{" "}
                                <span className="text-green-600">Crop Protection</span>
                            </h2>

                            <p className="mt-3 text-base leading-relaxed text-slate-500">
                                A practical approach to managing pests and supporting your
                                crops
                            </p>
                        </header>
                    ...
                    <ProductGallery category="Insecticide" />

                    {/* Bottom banner */}
                    <section className="mt-12 rounded-3xl bg-gradient-to-r from-green-50 to-emerald-50 p-3 md:p-4">
                        <div className="relative overflow-hidden rounded-2xl border border-green-200 bg-white/80 px-6 py-12 text-center md:px-12">
                            ...
                            <h2 className="relative text-3xl font-bold leading-tight tracking-tight md:text-5xl">
                                We understand your{" "}
                                <span className="text-green-600">crop&apos;s need</span>
                            </h2>

                            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-600">
                                From identifying pest challenges to choosing suitable crop
                                protection, make informed decisions for your farm with{" "}
                            ...
                            <p className="mx-auto mt-6 max-w-2xl rounded-xl bg-green-50 px-5 py-4 text-sm leading-6 text-green-800">
                                Use insecticides only for approved crops and pests. Read
                                and follow all label instructions before use.
                            </p>
                        </div>
                    </section>
                </div>
